...
from src.pawsafe.live_update import score_with_saved_model
...
model_path = root / "outputs/heat_cluster_model.joblib"
scored = score_with_saved_model(features, model_path, cfg, features)
