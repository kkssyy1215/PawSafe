...
export type WalkFlowState =
  ...
  | { status: 'segmentReview'; request: RouteAnalysisRequest; result: RouteAnalysisResponse; selectedSegmentId: string | null }
  | { status: 'comparison'; request: RouteAnalysisRequest; result: RouteAnalysisResponse }
