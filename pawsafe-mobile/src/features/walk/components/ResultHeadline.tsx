...
export function ResultHeadline({ result }: { result: RouteAnalysisResponse }) {
  return <View accessible accessibilityRole="header" style={styles.container}><Text style={styles.label}>PAWSAFE RECOMMENDATION</Text><Text style={styles.headline}>{getResultHeadline(result)}</Text></View>;
}
