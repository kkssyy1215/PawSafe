...
import type { HeatSegment, RouteStats, WalkMode } from '@/src/api/contracts';
...
export function MapTextSummary({ shortest, pawsafe, segments, walkMode = 'cool' }: { shortest?: RouteStats; pawsafe?: RouteStats; segments?: HeatSegment[]; walkMode?: WalkMode }) {
